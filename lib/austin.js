...
let Austin = function(configuration) {
  ...
  // add nba dot com resource for league stats access
  resources.nbaRequest = require('./nbaRequest');
  ...
  let parser = new messageParser.MessageParser(webClient, resources);
  parser.addListener(messageParser.statsListener());
  // parser.addListener(messageParser.standingsListener());
