...
let listener = function() {
  ...
  /// add a logger to the listener
  ///
  /// @logger is a logger that has warn, info, and error functions
  that.addLogger = function(logger) { that.logger = logger; };
